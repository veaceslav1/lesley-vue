<template>
  <div class="user-editor-container">
    <el-form :model="postForm" :rules="rules" ref="postForm" class="form-container" @submit.prevent>
      <el-form-item prop="username">
        <el-input v-model="postForm.username" placeholder="User Name" prefix-icon="el-icon-user" />
      </el-form-item>
      <el-form-item prop="password">
        <el-input type="password" v-model="postForm.password" placeholder="Password" prefix-icon="el-icon-lock"></el-input>
      </el-form-item>
      <el-form-item prop="passwordRepeat">
        <el-input type="password" v-model="postForm.passwordRepeat" placeholder="Password repeat" prefix-icon="el-icon-lock"></el-input>
      </el-form-item>
